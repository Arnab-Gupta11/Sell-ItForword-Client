                  ...
                  <tr key={item?._id} className="hover:bg-light-primary-bg dark:hover:bg-dark-primary-bg">
                    ...
                    <td className="px-4 py-2 border  border-[#e9ebec] dark:border-[#142e3a] text-sm">
                      {item?.paymentStatus === "completed" ? (
                        ...
                        <span className="bg-[#ffeef3] border-2 border-red-400 text-red-500 px-2 py-0.5 text-sm font-semibold rounded-lg">
                          Pending
                        </span>
                      )}
                    </td>
                    <td className="px-4 py-2 border  border-[#e9ebec] dark:border-[#142e3a] text-sm">
                      {item?.status === "completed" ? (
                        ...
                        <span className="bg-[#ffeef3] border-2 border-red-300 text-red-400 px-2 py-0.5 text-sm font-semibold rounded-lg">
                          Pending
                        </span>
                      )}
                    </td>
          ...
          <div className="min-h-[calc(100vh-100px)] col-span-3 flex items-center justify-center">
            <div className="text-center w-full">
              <div className="text-slate-500 font-semibold text-base md:text-2xl flex items-center justify-center gap-1 md:gap-5">
                <span> You haven&apos;t made any purchases yet! 🛍️ Start exploring our amazing listings and find something you love.</span>
              </div>
            </div>
          </div>
        )}
