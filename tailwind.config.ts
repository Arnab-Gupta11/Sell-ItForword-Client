  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "light-secondary-txt": "#525c6e",
        "dark-primary-txt": "#ebf0ff",
        "dark-secondary-txt": "#bad9e8",
        "dark-primary-bg": "#001321", //"#001321",
      ...
      boxShadow: {
        ...
        "box-shadow-dark": "rgba(17, 17, 26, 0.05) 0px 0px 16px 3px, rgba(17, 17, 26, 0.05) 0px 0px 16px 3px",
      },
      keyframes: {
        "accordion-down": {
          from: {
